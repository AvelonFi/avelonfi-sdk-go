// Package avelonfi provides the Go SDK for the avelon Fi privacy-native neo bank protocol.
package avelonfi
...
// avelonError is the structured error returned by the avelon API.
type avelonError struct {
...
func (e avelonError) Error() string {
	return fmt.Sprintf("avelonfi: [%d] %s — %s", e.Status, e.Code, e.Message)
}
...
// avelonConfig holds the configuration for an avelonClient.
type avelonConfig struct {
	APIKey       string
	BaseURL      string
	WsURL        string
